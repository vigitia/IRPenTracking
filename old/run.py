...
class Run:
    ...
    def __init__(self):
        ...
        self.base_image = shape_creator.draw_shape('shapes/wave.svg', (8000, 8000), 1000, LINE_THICKNESS, ShapeCreator.DASH, LINE_COLOR)
    ...
    def process_frame(self):
        ...
        if ir_image_table is not None:
            cv2.imshow('Realsense D435 IR frame', ir_image_table)
